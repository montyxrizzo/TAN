 ...
 */
contract TAN is Context, IERC20 {
    ...
    uint public _maxSupply = 1000000000;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        require(sender != address(0), "TAN: transfer from the zero address");
        require(recipient != address(0), "TAN: transfer to the zero address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(account != address(0), "TAN: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != address(0), "TAN: burn from the zero address");
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(0), "TAN: approve from the zero address");
        require(spender != address(0), "TAN: approve to the zero address");
 ...
 */
abstract contract TANCapped is TAN {
 ...
 */
abstract contract TANBurnable is Context, TAN {
    /**
 ...
 */
contract ERC1363 is TAN, IERC1363, ERC165 {
    using Address for address;
    ...
    ) public payable TAN(name, symbol) {
 ...
 */
contract BaseToken is TANCapped, TANBurnable, ERC1363, Roles, TokenRecover {
     ...
     * @return A boolean that indicates if the operation was successful.
     */
    function transfer(address to, uint256 value) public virtual override(TAN) canTransfer(_msgSender()) returns (bool) {
     ...
     * @return A boolean that indicates if the operation was successful.
     */
    function transferFrom(address from, address to, uint256 value) public virtual override(TAN) canTransfer(from) returns (bool) {
     ...
     * @dev See {ERC20-_beforeTokenTransfer}.
     */
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(TAN, TANCapped) {
        super._beforeTokenTransfer(from, to, amount);
    }
}
